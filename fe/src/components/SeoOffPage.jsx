      ...
      <div className="container mx-auto px-4 py-8">
        {showBanner && (
          <div className="banner bg-green-500 text-white p-4 rounded mb-4">
            <p>
              Test completato! Per migliorare i risultati consulta le <a href="http://localhost:3000/blog" className="underline text-white font-bold">Guide di SeoBoost</a> e impara a padroneggiare la SEO off-site del tuo sito web.
            </p>
          </div>
        )}
